...
describe('BloodPressure e2e test', () => {
    ...
    it('should load BloodPressures', () => {
        ...
        expect(bloodPressureComponentsPage.getTitle()).toMatch(/jhipsterMiniBookApp.bloodPressure.home.title/);
    });
    ...
    it('should load create BloodPressure page', () => {
        ...
        expect(bloodPressureUpdatePage.getPageTitle()).toMatch(/jhipsterMiniBookApp.bloodPressure.home.createOrEditLabel/);
