...
describe('Points e2e test', () => {
    ...
    it('should load Points', () => {
        ...
        expect(pointsComponentsPage.getTitle()).toMatch(/jhipsterMiniBookApp.points.home.title/);
    });

    it('should load create Points page', () => {
        pointsComponentsPage.clickOnCreateButton();
        pointsUpdatePage = new PointsUpdatePage();
        expect(pointsUpdatePage.getPageTitle()).toMatch(/jhipsterMiniBookApp.points.home.createOrEditLabel/);
