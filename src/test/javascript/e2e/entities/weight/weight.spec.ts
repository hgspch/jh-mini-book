...
describe('Weight e2e test', () => {
    ...
    it('should load Weights', () => {
        ...
        expect(weightComponentsPage.getTitle()).toMatch(/jhipsterMiniBookApp.weight.home.title/);
    });

    it('should load create Weight page', () => {
        weightComponentsPage.clickOnCreateButton();
        weightUpdatePage = new WeightUpdatePage();
        expect(weightUpdatePage.getPageTitle()).toMatch(/jhipsterMiniBookApp.weight.home.createOrEditLabel/);
